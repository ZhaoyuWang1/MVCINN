...
def main(model_name,N_EPOCHS=100,LR = 0.0001,depth=12,head=9):
    ...
    model = create.my_MVCINN(
        pretrained=True,
        num_classes=5,
        pre_Path = '/root/autodl-fs/MVCINN/MVCINN-code/weights/main_1e-05_50_d12_h9-0.7555.pth', #'/root/autodl-fs/MVCINN/MVCINN-code/weights/Conformer_base_patch16.pth',
        depth=depth,
        num_heads=head,
        # embed_dim=768,
        drop_rate=0.2,
    ...
    for epoch in range(N_EPOCHS):
        ...
        for i, (img, label) in enumerate(train_bar):
            ...
            #print(f"input data is {imgs_mix}")
